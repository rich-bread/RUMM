...
namespace RUMM.Method
{
    public class Integrate
    {
        ...
        public static void Original_Area_WithCoord(string area_text_path, string trimedmap_folder, string areacompmap_path)
        {
            List<string> coordslist = new List<string>();
            List<int> xcoordslist = new List<int>();
            List<int> zcoordslist = new List<int>();
            ...
            foreach (string mapcoord in coordslist)
            {
                ...
                Bitmap image = new Bitmap($@"{trimedmap_folder}\{mapxcoord},{mapzcoord}.png");
                Graphics graphics = Graphics.FromImage(image);

                Font font = new Font("MS UI Gothic", 75);

                graphics.DrawString($"{mapxcoord},{mapzcoord}", font, Brushes.Black, 96, 96);

                Pen blackline = new Pen(Color.FromArgb(255, 0, 0, 0), 10);
                Point[] points =
                {
                    new Point(0,0),
                    new Point(0,384),
                ...
                graphics.DrawLines(blackline, points);

                graphics.DrawImage(image, 0, 0, scale, scale);
        ...
        public static void Designed_Realm3rd_Area_WithCoord(string area_text_path, string trimedmap_folder, string areacompmap_path)
        {
            List<string> coordslist = new List<string>();
            List<int> xcoordslist = new List<int>();
            List<int> zcoordslist = new List<int>();
